...
class UserSignUpForm(UserCreationForm):
    ...
    SchoolChoice=(('tandon school','tandon school'),('other school','other school'))
    DepartmentChoice=(('Computer Science','computer science'),('other department','other'))
    ...
    Phone = forms.CharField(label="Phone", help_text='Optional',
                            widget=forms.TextInput(attrs={'class': "input100", 'placeholder': "phone",'autofocus': ''}))
    school = forms.ChoiceField(label="school", required=False, help_text='True',choices=SchoolChoice,
                             widget=forms.Select(attrs={'class': "input100", 'placeholder': "school",'autofocus': ''}))
    department = forms.ChoiceField(label="department", required=False, help_text='True',choices=DepartmentChoice,
                             widget=forms.Select(attrs={'class': "input100", 'placeholder': "department", 'autofocus': ''}))
