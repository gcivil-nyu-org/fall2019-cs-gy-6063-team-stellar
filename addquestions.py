...
def addquestion():
    q = Question(question_text="Did you show up?", pub_date=datetime.now(tz=get_current_timezone()))
    q.label = "attendance"
    q.save()
    q.choice_set.create(choice_text='Yes!')
    q.choice_set.create(choice_text='I\'d love to, but I got something emergency...')

    q1 = Question(question_text="How likely are you to recommend LunchNinja to a NYU community member?", pub_date=datetime.now(tz=get_current_timezone()))
    q1.label = "experience"
    q1.save()
    ...
    q2 = Question(question_text="How likely are you to recommend the restaurant to a friend or family member?", pub_date=datetime.now(tz=get_current_timezone()))
    q2.label = "restaurant"
    q2.save()
    ...
    q3 = Question(question_text="How would you rate your experience with your lunch partner (considering punctuality and behavior/attitude, etc.)?", pub_date=datetime.now(tz=get_current_timezone()))
    q3.label = "partner"
    q3.save()
