...
def send_unmatch_email(userrequest):
    ...
    html_content = (
            ...
            + "We are working on finding a perfect match for you according to your preferences, but we could not find a match based on your service selection at this time.<br>"
    ...
    msg = EmailMessage(
        "Sorry, we could not find a match", None, "teamstellarse@gmail.com", [user.email]
    )
    msg.attach(
        html_part
